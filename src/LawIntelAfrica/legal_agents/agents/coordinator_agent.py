...
from documents.documents import AgentResponse, Query
...
class CoordinatorAgent(BaseAgent):
    ...
    def __init__(
        self,
        agent_id: str,
        retrieval_agents: List[BaseAgent],
        processing_agent: BaseAgent,
    ):
    ...
    async def process(self, query: str) -> AgentResponse:
        ...
        try:
            ...
            processing_result = await self.processing_agent.process(
                {"documents": unique_docs_list, "question": query}
            )
            ...
            return AgentResponse(
                ...
                metadata={
                    "retrieval_agents": [
                        agent.agent_id for agent in self.retrieval_agents
                    ],
