...
from utils.setup import download_models
...
async def main():
    ...
    try:
        ...
        coordinator = CoordinatorAgent(
            "workflow_coordinator", [semantic_agent, keyword_agent], processing_agent
        )

        # Run the workflow
        query = "Quelles sont les exigences légales pour démarrer une entreprise en Afrique ?"
